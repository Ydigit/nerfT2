...
def config_parser():
    ...
    parser.add_argument("--chunk", type=int, default=1024*16, help='reduce if running out of memory')
    parser.add_argument("--netchunk", type=int, default=1024*32, help='reduce if running out of memory')
...
def train():
    ...
    # Summary writers
    writer = tf_summary.create_file_writer(
    ...
    for i in range(start, N_iters):
        ...
        if i % args.i_print == 0 or i < 10:
            ...
            step = i  # Define o número da iteração atual como passo para os logs
            ...
            if i % args.i_img == 0:
                ...
                if not os.path.exists(testimgdir):
                    print(f"Diretório {testimgdir} não encontrado, criando agora...")
